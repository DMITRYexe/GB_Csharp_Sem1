...
Console.WriteLine("Привет! Данное ПО выводит максимальную цифру в целом числе из диапазона [10;99]");
...
{
  Console.WriteLine("Ошибка. Что-то пошло не так"); // профилактика от ошибок
}
}
else
{
